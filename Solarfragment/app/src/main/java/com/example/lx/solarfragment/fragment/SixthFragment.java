        ...
        if(view==null){
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mainActivity.switchFragment("fragment6","fragment4");
                }
            });
            textView=view.findViewById(R.id.title1);
            textView.setText("过去一年");
            btnWeek=(Button) view.findViewById(R.id.week);
            btnMonth=view.findViewById(R.id.month);
            btnWeek.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mainActivity.switchFragment("fragment6","fragment3");
                }
            });
            btnMonth.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mainActivity.switchFragment("fragment6","fragment5");
                }
            });
    ...
    public static class Sum extends AsyncTask {
        ...
        protected Object doInBackground(Object[] objects){
            ...
            try {
                ...
                Log.e("year","year");
                writer.write("year="+getYear()+"&month="+getMonth()+"&num=3&userId="+userId);
                writer.flush();
                writer.close();
                connection.connect();
