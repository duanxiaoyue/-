...
public class LoginActivity extends AppCompatActivity {
    ...
    static public String CLIENTURL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("login***clientUrl",clientUrl);
        CLIENTURL = clientUrl;
        pwd=findViewById(R.id.password);
        login=findViewById(R.id.login);
        loginname=findViewById(R.id.login_name);
        cbRem=findViewById(R.id.rem);
        cbauto=findViewById(R.id.auto);
        sharedPreferences=getSharedPreferences("myInfo",MODE_PRIVATE);//第二个是打开的方式
        //实现自动登录的
        isAutoLogin();
    ...
    public void isAutoLogin(){
        ...
        Boolean isRem=sharedPreferences.getBoolean("isRem",false);
        if(isRem){
            cbRem.setChecked(true);//把复选框选上
            loginname.setText(sharedPreferences.getString("username",""));
...
//    }
    ...
    public class LoginTask extends AsyncTask{
        ...
        protected Object doInBackground(Object[] objects) {
            String path=clientUrl+"loginServlet";
            try {
            ...
            public void handleMessage(Message msg) {
                switch(msg.what){
                    ...
                    case 2:
                        ...
                        if(cbRem.isChecked()){//如果选中的话，ischecked为TRUE
